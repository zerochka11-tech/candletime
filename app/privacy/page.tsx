    ...
    <div className="flex flex-col gap-6 md:gap-8">
        ...
        <div className="relative space-y-4">
          ...
          <p className="text-sm leading-relaxed text-slate-700 md:text-base">
            ...
            <a
              ...
              className="font-medium text-slate-900 underline transition-colors hover:text-slate-700"
            >
      ...
      <section className="relative overflow-hidden rounded-3xl border border-slate-300 bg-gradient-to-br from-white via-slate-50/50 to-white p-4 shadow-md sm:p-6 md:p-8">
        ...
        <div className="relative space-y-4">
          ...
          <div className="mt-6 rounded-2xl border border-slate-300 bg-white p-4 shadow-md sm:p-6">
            <div className="mb-4 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
              <div>
                <h3 className="text-base font-semibold text-slate-900 sm:text-lg">Управление cookies</h3>
              ...
              {!showCookieSettings && (
                <button
                  ...
                  className="rounded-lg bg-slate-900 px-4 py-2 text-xs font-medium text-white transition-all duration-300 hover:-translate-y-0.5 hover:bg-slate-800 hover:shadow-md sm:text-sm"
                >
                  Настроить cookies
                </button>
              )}
            ...
            {showCookieSettings && (
              <div className="space-y-4">
                <div className="space-y-3">
                  <div className="group flex items-center justify-between rounded-xl border border-slate-200 bg-slate-50 p-3 transition-all duration-300 hover:border-slate-300 hover:shadow-sm sm:p-4">
                    <div>
                      <p className="text-sm font-medium text-slate-900 sm:text-base">Необходимые</p>
                  ...
                  <div className="group flex items-center justify-between rounded-xl border border-slate-200 bg-slate-50 p-3 transition-all duration-300 hover:border-slate-300 hover:shadow-sm sm:p-4">
                    <div>
                      <p className="text-sm font-medium text-slate-900 sm:text-base">Аналитика</p>
                      <p className="mt-1 text-xs text-slate-600">
                ...
                <div className="flex flex-wrap gap-2 sm:gap-3">
                  <button
                    ...
                    className="rounded-lg border border-slate-300 bg-white px-3 py-2 text-xs font-medium text-slate-700 transition-all duration-300 hover:-translate-y-0.5 hover:border-slate-400 hover:bg-slate-50 hover:shadow-md sm:px-4 sm:text-sm"
                  >
                    Отклонить аналитику
                  </button>
                  <button
                  ...
                  <button
                    ...
                    className="rounded-lg bg-slate-900 px-3 py-2 text-xs font-medium text-white transition-all duration-300 hover:-translate-y-0.5 hover:bg-slate-800 hover:shadow-md sm:px-4 sm:text-sm"
                  >
                    Принять все
                  </button>
                  <button
      ...
      <div className="relative overflow-hidden rounded-3xl border border-slate-300 bg-gradient-to-br from-white via-slate-50/50 to-white p-4 shadow-md sm:p-6 md:p-8">
        {/* Декоративный градиент */}
        <div className="absolute inset-0 bg-gradient-to-r from-amber-500/5 via-transparent to-indigo-500/5" />
